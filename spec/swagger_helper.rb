        ...
        schemas: {
          ...
          Note: {
            ...
            properties: {
              ...
              board_position: { type: :integer, nullable: true, description: 'All Notes masonry board order, ascending within the pinned or unpinned zone.', example: 0 },
              folder_board_position: { type: :integer, nullable: true, description: 'Folder masonry board order inside the current folder, ascending within the pinned or unpinned zone.', example: 0 },
            ...
            required: %w[id title body folder_id pinned position board_position folder_board_position empty created_at updated_at url html_url images]
          },
          Changes: {
            type: :object,
