...
class SyncEngine(
    ...
    private suspend fun pushNote(n: NoteEntity) {
        val fields = NoteFields(n.id, n.title, n.body, n.folderId, n.pinned, n.boardPosition)
        when {
            n.pendingDelete -> {
    ...
    private suspend fun pull() {
        ...
        for (n in changes.notes) {
            ...
            else notes.upsert(NoteEntity(n.id, n.title, n.body, n.folder_id, n.pinned, n.board_position, n.updated_at))
        }
